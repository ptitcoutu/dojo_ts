export const isPangram = (phrase: string): boolean => {
    ...
    const listOfEmptyCharacters = Array.from(new Array(ALPHABET_SIZE)) // because new Array create an empty array with length ALPHABET_SIZE even if there's no real value in the array.
